...
//
//
//     div.append(divName, divSurname, divAge, divInfo, img)
//     document.body.appendChild(div);
//
// }
//
...
for (const ArrayEl of coursesArray) {
    let mainDiv = document.createElement('div')
    mainDiv.className = 'item'
    let titleDiv = document.createElement('div')
    titleDiv.className = 'title'
    let monthDurationDiv = document.createElement('div')
    monthDurationDiv.className = 'monthDurationDiv'
    let hourDurationDiv = document.createElement('div')
    hourDurationDiv.className = 'hourDurationDiv'
    let modulesDiv = document.createElement('div')
    modulesDiv.className = 'modules'

    for (const El of ArrayEl.modules) {
        let div = document.createElement('div')
        div.innerText = El
        modulesDiv.appendChild(div)
    }

    titleDiv.innerText = ArrayEl.title
    monthDurationDiv.innerText = `month duration: ${ArrayEl.monthDuration}`
    hourDurationDiv.innerText = `hour duration: ${ArrayEl.hourDuration}`


    mainDiv.append(titleDiv, monthDurationDiv, hourDurationDiv, modulesDiv)
